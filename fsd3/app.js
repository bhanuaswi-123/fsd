...
// const client = redis.createClient({host : 'localhost', port : 3000});
...
if(process.env.NODE_ENV === 'production'){
  app.use(express.static(path.join(__dirname,"/fsd2/build")));

  app.get('*',(req,res)=>{
    res.sendFile(path.resolve(__dirname,'fsd2','build','index.html'))
  })
}
